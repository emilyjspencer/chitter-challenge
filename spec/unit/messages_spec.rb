...
describe Messages do
  ...
  describe '.all' do
    it 'retrieves all of the messages' do
      ...
      message = Messages.create_message(name: 'Emily', message: 'We are learning how to build a full-stack application', peep_handle: 'lajoiedevivre89')
      ...
      expect(message.handle).to eq 'lajoiedevivre89' 
  ...
  describe '.create_message' do
   it 'creates a new message' do
     message = Messages.create_message(name: 'Emily', message: 'Hello', peep_handle: 'lajoiedevivre89')

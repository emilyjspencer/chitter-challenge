...
describe '.all' do
  it 'retrieves all of the messages' do
    ...
    connection.exec("INSERT INTO messages(message) VALUES ('We are learning how to build a full-stack application');") # add test1
    connection.exec("INSERT INTO messages(message) VALUES ('From Monday we will no longer be the newest cohort');") # add test message 2
    connection.exec("INSERT INTO messages(message) VALUES ('Tweets sound better than peeps');") # add test message 3
